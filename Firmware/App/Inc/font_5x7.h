/**
 * font_5x7.h
 * Basit ASCII 5x7 piksel font (yazdırılabilir aralık 0x20..0x7E, 95 karakter).
 * Her karakter 5 byte; her byte bir sütun (LSB en üstteki piksel).
 * Bit 0 = satır 0 (en üst), bit 6 = satır 6 (en alt). Bit 7 kullanılmıyor.
 *
 * Render mantığı: her sütun için 0..6 bit'lerini incele, '1' ise foreground,
 * '0' ise background piksel ata.
 */
#ifndef FONT_5X7_H
#define FONT_5X7_H
...
static const uint8_t FONT_5X7[(FONT_LAST_CHAR - FONT_FIRST_CHAR + 1) * FONT_COLS] = {
