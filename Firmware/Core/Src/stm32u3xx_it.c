...
void EXTI0_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(BLE_EVENT_Pin);
...
void EXTI1_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(FDC_ERRB_Pin);
...
void EXTI5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(FLT_TEMP_Pin);
...
void EXTI6_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(LOOP_FLT_Pin);
...
void EXTI7_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(FDC_INT_Pin);
